...
const MenuItemModal: FC<MenuItemModalProps> = ({ item, isOpen, onClose }) => {
  ...
  return (
    <div
      ...
      onClick={onClose}>
      <div
        className='bg-white rounded-[28px] p-4 sm:p-6 lg:p-8 relative max-w-[575px] w-full max-h-[90vh] overflow-y-auto'
        onClick={(e) => e.stopPropagation()}>
        <div className='flex justify-between'>
          <div className='mb-4 sm:mb-6'>
            <div className='flex gap-5 items-center'>
              <div className='text-[#1E1E1E] text-[20px] sm:text-[24.68px] font-medium leading-tight'>
                {item?.itemName}
              </div>
            ...
            <div className='text-[#1E1E1E] text-[14px] sm:text-[15.8px] font-medium opacity-50 mt-2'>
        ...
        <div className='mb-6 sm:mb-8'>
          <div className='text-black text-[12px] sm:text-[13.18px] font-medium leading-relaxed opacity-30'>
        ...
        <div className='flex justify-end gap-12'>
          <div className='text-[#F4CBDF] text-[20px] sm:text-[22.03px] font-medium'>
            {item?.itemPrice} SR
          </div>
