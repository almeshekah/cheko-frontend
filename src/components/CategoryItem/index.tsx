...
const CategoryItem: FC<CategoryItemProps> = ({ category }) => {
  return (
    <div className='relative bg-white dark:bg-[#F4CBDF] border border-[#FCEFF5] dark:border-[#F4CBDF] rounded-[10px] hover:shadow-lg transition-shadow cursor-pointer h-[71px] flex items-center w-[209.59px] flex-shrink-0 px-[14px] py-[10px] shadow-[0px_7px_24px_0px_rgba(220,223,228,0.4)] dark:shadow-sm'>
